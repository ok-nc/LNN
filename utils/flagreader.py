...
# Imports hyperparameters from LNN folder. Parameters from either LNN or DNN should be consistent.
from forward.lorentz_model.hyperparameters import *
# from forward.DNN.hyperparameters import *

# Reads in the flags from the parameters file. For additional comments on each argument, see hyperparameters.py
def read_flag():
    """
...
#                        help='decay learning rate at this number of steps')
    ...
    parser.add_argument('--ntwk-noise', type=float, default=NTWK_NOISE,
                        help='Adds noise to network weights during training')
