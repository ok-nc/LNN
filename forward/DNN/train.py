...
def training_from_flag(flags):
    ...
    # Do the housekeeping, write the parameters and put into folder, also use pickle to save the flags object
    write_flags_and_BVE(flags, ntwk.best_validation_loss, ntwk.best_mse_loss, ntwk.ckpt_dir)

def evaluate_from_model(model_dir):
    """
    Evaluating interface. 1. Retrieve the flags 2. get data 3. initialize network 4. eval
