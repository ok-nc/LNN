...
def evaluate_from_model(model_dir):
    ...
    # Evaluation process. There are multiple evaluation functions for both spectra and Lorentz parameters.
    print("Start eval now:")
    # pred_T_file, truth_T_file, pred_R_file, truth_R_file, eps_param_file, mu_param_file = ntwk.evaluate()
    eps_wp_file, eps_w0_file, eps_g_file, eps_inf_file, mu_wp_file, \
        mu_w0_file, mu_g_file, mu_inf_file = ntwk.evaluate_lorentz_params()
    ...
    #    adv_im_file = ntwk.evaluate_physics_output()
...
if __name__ == '__main__':
    ...
    # dummy_flags = fr.read_flag()
    #
    # print(dummy_flags.eval_model)
    # # Call the evaluate function from model
    # evaluate_from_model(dummy_flags.eval_model)
